...
for l=1:k
    ...
    for i=1:n
        if X(i,l)
            ...
            elseif l==4
                plot(A(i,1), A(i,2), '*y', 'MarkerSize', 20);
            elseif l==5
                plot(A(i,1), A(i,2), '*m', 'MarkerSize', 20);
             elseif l==6
                plot(A(i,1), A(i,2), 'dg', 'MarkerSize', 20);
             elseif l==7
                plot(A(i,1), A(i,2), 'dr', 'MarkerSize', 20);
            elseif l==8
                plot(A(i,1), A(i,2), 'db', 'MarkerSize', 20);
            end
        end
    end
